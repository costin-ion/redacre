...
#creating an elastic(static) ip requered for NetGateway
...
#creating NetGateway witinn a public subnet
...
resource "aws_route_table_association" "private" {
  count = var.private_subnet_count
  #element fucntion will grab a single element from a list.
